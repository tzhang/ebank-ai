    ...
    <>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <span className="inline-flex items-center rounded-full border border-gold-500/30 bg-gold-500/10 px-3 py-1 text-xs font-medium text-gold-300">
              FinLLM × Agent Harness
            </span>
            <h1 className="mt-6 text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
              金融大模型
              <span className="gradient-text block">× Agent Harness</span>
            </h1>
            <p className="mt-6 text-lg leading-relaxed text-navy-200">
              ebank.ai 聚焦金融大模型与智能体运行框架：从模型选型、评测方法，
              到 Claude Code、Codex 等 Harness 的金融实战，
              并提供 Skills 与 MCP 技能生态的分享社区。
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-xl border border-navy-600/50 bg-navy-800/50 p-6 card-hover">
              ...
              <h3 className="mb-2 font-semibold text-white">金融大模型</h3>
              <p className="text-sm leading-relaxed text-navy-300">
                模型全景、选型框架与评测方法。看懂 DeepSeek、Claude、GPT
                在金融场景的能力边界，选对模型、用对模型。
              </p>
            </div>
            ...
            <div className="rounded-xl border border-navy-600/50 bg-navy-800/50 p-6 card-hover">
              ...
              <h3 className="mb-2 font-semibold text-white">Agent Harness 实战</h3>
              <p className="text-sm leading-relaxed text-navy-300">
                Claude Code、Codex、Cursor、OpenClaw 等运行框架的概念、选型与
                金融落地：自动化财报分析、尽调、合规扫描与安全权限设计。
              </p>
            </div>
            ...
            <div className="rounded-xl border border-navy-600/50 bg-navy-800/50 p-6 card-hover">
              ...
              <h3 className="mb-2 font-semibold text-white">Skills & MCP 生态</h3>
              <p className="text-sm leading-relaxed text-navy-300">
                精选 GitHub 金融 AI Skills 与 MCP 服务：行情数据、合规扫描、
                财报分析，即装即用，兼容主流 Harness。
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          ...
          <p className="mt-2 text-navy-300">金融大模型与 Agent Harness 的最新文章与资源</p>
        </div>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 animate-stagger">
          <FeaturedCard
            ...
            tagColor="gold"
            title="金融大模型全景"
            desc="从通用模型到金融专用模型：选型框架、私有化部署与成本权衡。"
            href="/llm/finllm-landscape"
          />
          <FeaturedCard
            tag="Harness"
            tagColor="blue"
            title="什么是 Agent Harness？"
            desc="模型是引擎，Harness 是整辆车：理解大模型落地的关键架构。"
            href="/harness/what-is-agent-harness"
          />
          <FeaturedCard
            tag="技能"
            tagColor="gold"
